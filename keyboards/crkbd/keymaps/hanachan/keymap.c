...
#define KC_S_SCLN RSFT_T(KC_SCLN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,----+----+----+----+----+----.     ,----+----+----+----+----+----.
         , Q  , W  , E  , R  , T  ,       Y  , U  , I  , O  , P  ,    ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
         ,S_A , S  , D  , F  , G  ,       H  , J  ,A_K , L  ,S_SCLN,     ,
  //|----+----+----+----+----+----+     |----+----+----+----+----+----|
         , Z  ,A_X , C  , V  , B  ,       N  , M  ,COMM,A_DOT,SLSH,    ,
  //`----+----+----+----+----+----/     \----+----+----+----+----+----'
                    M_EN,L_SPC,C_BS,    C_BS,R_ENT,M_JA
  //          `----+----+----+----'     `----+----+----+----'
  ),
  ...
  [_RAISE] = LAYOUT_kc( \
 //,----+----+----+----+----+----.     ,----+----+----+----+----+----.
         ,BSLS,EXLM,AMPR,PIPE,XXXX,      XXXX,EQL ,PLUS,ASTR,DLR ,    ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
         ,TAB ,GRV ,DQT ,QUOT,TILD,      LEFT,DOWN, UP ,RGHT,ESC ,    ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
         ,HASH,CIRC,LCBR,LBRC,LPRN,      RPRN,RBRC,RCBR,AT  ,PERC,    ,
  //`----+----+----+----+----+----/     \----+----+----+----+----+----'
                        ,BSPC,    ,          ,    ,RST
  //          `----+----+----+----'     `----+----+----+----'
  ),
  ...
  [_LOWER] = LAYOUT_kc( \
  //,----+----+----+----+----+----.     ,----+----+----+----+----+----.
         , F1 , F2 , F3 , F4 , F5 ,      F6  ,EQL ,PLUS,ASTR,MINS,    ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
         , 1  , 2  , 3  , 4  , 5  ,       6  , 7  , 8  , 9  , 0  ,    ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
         , F7 , F8 ,F9  ,F10 ,F11 ,      F12 ,PERC,COMM,DOT ,SLSH,    ,
  //`----+----+----+--+-+----+----/     \----+----+----+----+----+----'
                    RST ,    ,    ,          ,DEL ,    
  //          `----+----+----+----'     `----+----+----+----'
  ),
