...
[_QWERTY] = LAYOUT( \
  ...
  KC_Z,LALT_T(KC_X),KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, \
                    LCMD_T(KC_LANG2),LT(_LOWER, KC_SPC),LCTL_T(KC_BSPC),   RCTL_T(KC_BSPC),LT(_RAISE, KC_ENT),RCMD_T(KC_LANG1)  \
),
