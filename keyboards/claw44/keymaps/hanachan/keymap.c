...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
    S_TAB, A  , S  , D  ,M_F ,C_G ,      C_H ,M_J , K  , L  ,SCLN,S_ESC,
  //|----+----+----+----+----+----+     |----+----+----+----+----+----|
         , Z  , X  , C  , V  , B  ,       N  , M  ,COMM,DOT ,SLSH,    ,
  //`----+----+----+----+----+----/     \----+----+----+----+----+----'
             A_DEL,M_EN,L_SPC,C_BS,      C_BS,R_ENT,M_JA,A_DEL
  //          `----+----+----+----'     `----+----+----+----'
  ),
  ...
  [_RAISE] = LAYOUT_kc( \
  //,----+----+----+----+----+----.     ,----+----+----+----+----+----.
         ,BSLS,EXLM,AMPR,PIPE,XXXX,      XXXX,EQL ,PLUS,ASTR,MINS,    ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
         ,HASH,GRV ,DQT ,QUOT,TILD,      LEFT,DOWN, UP ,RGHT,DLR ,    ,
  //|----+----+----+----+----+----|     |----+----+----+----+----+----|
         ,    ,CIRC,LCBR,LBRC,LPRN,      RPRN,RBRC,RCBR,AT  ,PERC,    ,
  //`----+----+----+----+----+----/     \----+----+----+----+----+----'
                   ,    ,BSPC,    ,          ,    ,    ,RST
  //          `----+----+----+----'     `----+----+----+----'
  ),
